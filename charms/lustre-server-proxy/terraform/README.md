# Terraform module for lustre-server-proxy
...
|---------------|-------------|--------------------------------------------------------------------|-------------------------|:--------:|
| `app_name`    | string      | Name for the deployed application                                  | `"lustre-server-proxy"` |          |
...
module "lustre-server-proxy" {
  source     = "git::https://github.com/canonical/filesystem-charms//charms/lustre-server-proxy/terraform"
