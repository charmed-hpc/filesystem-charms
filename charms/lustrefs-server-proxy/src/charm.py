...
"""LustreFS server proxy charm operator for mount non-charmed LustreFS shares."""
...
from charms.filesystem_client.v0.filesystem_info import FilesystemProvides, LustrefsInfo

logger = logging.getLogger(__name__)


class LustreFSServerProxyCharm(ops.CharmBase):
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(LustreFSServerProxyCharm)
